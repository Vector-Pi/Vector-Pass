...
class SecurePasswordManager:
    ...
    def generate_password_interactive(self):
        ...
        try:
            ...
            if password:
                ...
                if strength['leaked']:
                    print("⚠️  Warning: Similar passwords found in data breaches!")
    ...
    def vault_operations_menu(self):
        ...
        while True:
            ...
            print("\n" + "="*50)
            print(f"🗂️  VAULT: {vault_name} ({entry_count} entries)")
            print("="*50)
...
if __name__ == "__main__":
    ...
    if not os.listdir("data/leaked_passwords"):
        print("⚠️  No leaked password wordlists found in data/leaked_passwords/")    
    main()